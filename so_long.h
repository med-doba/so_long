...
/*   Updated: 2022/04/27 22:39:32 by med-doba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_read(char *str, t_lay *map, int fd);
...
void 	ft_up(t_lay *map, int *i, int *j);
void 	ft_move_down(t_lay *map, int *i, int *j);
void 	ft_down(t_lay *map, int *i, int *j);
void 	ft_move_rigth(t_lay *map, int *i, int *j);
void 	ft_rigth(t_lay *map, int *i, int *j);
void 	ft_move_left(t_lay *map, int *i, int *j);
void 	ft_left(t_lay *map, int *i, int *j);
#endif
